 ...
 * 
 * Increases multiplier by <BOOST_PERC / 100> per count.
 * Maximum multiplier is <BOOST_MAX> at 
 *     busy_bcounter=<BUSY_BMAX - BUSY_BMIN>.
 * Minimum multiplier is <BOOST_MIN> at 
 *     busy_bcounter=1.
 * 
 * (1*) - already incremented for MIN_BUSY.
 */
#define BOOST_MAX 4
#define BOOST_MIN 2
