...
static void check_dash_status(struct work_struct *work)
{
	...
	/* Make sure we do not have any overrides or suspend configured */
	smblib_set_icl_current(g_chg, INT_MAX);
...
int smblib_init(struct smb_charger *chg)
{
	...
	INIT_WORK(&chg->re_kick_work, op_re_kick_work);
